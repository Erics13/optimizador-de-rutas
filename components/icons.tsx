...
export const RouteIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.633 10.25c.806 0 1.533-.446 2.031-1.08a9.041 9.041 0 012.861-2.4c.723-.384 1.35-.956 1.653-1.715a4.498 4.498 0 00.322-1.672V2.75a.75.75 0 01.75-.75 2.25 2.25 0 012.25 2.25c0 1.152-.26 2.243-.723 3.218-.266.558.107 1.282.725 1.282h3.126c1.026 0 1.945.694 2.054 1.715.045.422.068.85.068 1.285a11.95 11.95 0 01-2.649 7.521c-.388.482-.987.729-1.605.729H13.48c-.483 0-.964-.078-1.423-.23l-3.114-1.04a4.501 4.501 0 00-1.423-.23H5.904m10.598-9.75c.023.222.045.448.067.676v.162c0 .228-.024.455-.067.676m-1.5-1.35l-.11.676m.22 0l-.11-.676m1.32.676l-.11.676m-.22 0l.11-.676m-3.232 4.423l-3.114 1.04a4.501 4.501 0 01-1.423.23H5.904m-1.008-2.58l.11-.676m-.22 0l-.11.676m1.32.676l-.11-.676m-.22 0l.11.676m-3.463-3.75l.11.676m-.22 0l-.11.676m1.32.676l-.11-.676m-.22 0l.11.676" />
    </svg>
);

export const MapIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m0 0v-8.25m0 8.25h3.75m-3.75 0H5.25m11.25 0H18v-5.25h-2.25m0 5.25v-5.25m0 5.25h-3.75m3.75 0h3.75M3 12h18M3 12a9 9 0 1118 0 9 9 0 01-18 0z" />
    </svg>
);

export const TableIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125v-1.5c0-.621.504-1.125 1.125-1.125H6.75m13.5 0H20.25a1.125 1.125 0 011.125 1.125v1.5c0 .621-.504 1.125-1.125 1.125m-17.25 0h17.25m-17.25 0H6.75m13.5 0H20.25m-17.25 0H6.75m0 0v-3.75c0-1.036.84-1.875 1.875-1.875h7.5c1.035 0 1.875.84 1.875 1.875v3.75m-11.25 0h11.25" />
    </svg>
);
...
export const CloudArrowUpIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5V9.75m0 0l-3.75 3.75M12 9.75l3.75 3.75M6.375 19.5h11.25A2.625 2.625 0 0020.25 16.875V16.5m-13.5 0v.375c0 .621.504 1.125 1.125 1.125h2.25m-3.375 0V16.5m0 0V6.75A2.625 2.625 0 016.375 4.125h11.25a2.625 2.625 0 012.625 2.625v9.75m-16.5 0a2.625 2.625 0 002.625 2.625h11.25a2.625 2.625 0 002.625-2.625m-16.5 0h16.5" />
    </svg>
);
